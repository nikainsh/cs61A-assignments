...
def boar_brawl(player_score, opponent_score):
    ...
    if opponent_score < 10:
        ...
        oppnent_tens = (opponent_score // 10) % 10
    diff = abs(player_score%10 - oppnent_tens)
    return max(3*diff, 1)
    # END PROBLEM 2
...
def play(strategy0, strategy1, update, score0=0, score1=0, dice=six_sided, goal=GOAL):
    ...
    while(score0<goal and score1<goal):
        if who == 0:
            score0 = update(num_rolls=strategy0(score0, score1),player_score=score0,opponent_score=score1,dice=dice)
        elif who == 1:
            score1 = update(num_rolls=strategy1(score1, score0),player_score=score1,opponent_score=score0,dice=dice)
        who = 1-who
    # END PROBLEM 5
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def constant_roll(player_score, opponent_score):
        return n
